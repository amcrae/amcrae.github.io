...
renderState = {
	...
	clocker:0,
	quantumMS:03,
	sliceLimit:30			// HEY! change this down to 10 or 1 if your computer is too slow.
};
...
function testGraphRender() {
	drawPlotArea(10,10);
	var f = function(x,y) { return modInt(x,2)+modInt(y,3);  };
	var c = function(v)   { return v==1?'blue' : (v==2?'green' : (v==3?'red': 'white') )  };
	render2DFunction( 
		f,
...
function drawTupper() {
	...
	var c = function(v)   { return v ? 'black' : 'white'; };
	render2DFunction( 
		Tupper,
